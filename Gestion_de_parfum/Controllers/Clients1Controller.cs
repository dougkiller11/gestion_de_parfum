...
namespace Gestion_de_parfum.Controllers
{
    public class Clients1Controller : Controller
    {
        ...
        {
            var applicationDbContext = _context.Clients.Include(c => c.Utilisateur);
        ...
        public async Task<IActionResult> Create([Bind("Id,Adresse,Telephone")] Client client)
        {
            ...
            ViewData["Id"] = new SelectList(_context.Utilisateurs, "Id", "Email", client.Id);
            return View(client);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Adresse,Telephone")] Client client)
        {
            if (id != client.Id)
            {
                return NotFound();
